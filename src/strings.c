...
const u8 gText_DefaultNameLillie[] = _("Liliana");
const u8 gText_DefaultNameTerra[] = _("Terra");
const u8 gText_DefaultNameLucy[] = _("Lucy");
const u8 gText_DefaultNameHalie[] = _("Haley");
const u8 gText_ThisIsAPokemon[] = _("Pseudo jumpscare.{PAUSE 96}\p");
...
const u8 gText_DadsAdvice[] = _("It is against tournament policy\nto use this here.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_OnlyUseOnStarter[] = _("This item only works on\nMeganium, Infernape or Blastoise.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_EggCantBattle[] = _("bruh{PAUSE_UNTIL_PRESS}");
...
const u8 gText_XNatureMetAtYZ[] = _("{DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}{DYNAMIC 5}, met at {LV_2}{DYNAMIC 0}{DYNAMIC 3}{DYNAMIC 1},\n{DYNAMIC 0}{DYNAMIC 4}{DYNAMIC 1}.");
const u8 gText_XNatureHatchedAtYZ[] = _("{DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}{DYNAMIC 5}, hatched at {LV_2}{DYNAMIC 0}{DYNAMIC 3}{DYNAMIC 1},\n{DYNAMIC 0}{DYNAMIC 4}{DYNAMIC 1}.");
...
const u8 gText_XNatureProbablyMetAt[] = _("{DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}{DYNAMIC 5}, likely met\nat {LV_2}{DYNAMIC 0}{DYNAMIC 3}{DYNAMIC 1}, {DYNAMIC 0}{DYNAMIC 4}{DYNAMIC 1}.");
const u8 gText_XNature[] = _("{DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}{DYNAMIC 5} nature.");
const u8 gText_XNatureMetSomewhereAt[] = _("{DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}{DYNAMIC 5}, met somewhere\nat {LV_2}{DYNAMIC 0}{DYNAMIC 3}{DYNAMIC 1}.");
const u8 gText_XNatureHatchedSomewhereAt[] = _("{DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}{DYNAMIC 5}, hatched\nsomewhere at {LV_2}{DYNAMIC 0}{DYNAMIC 3}{DYNAMIC 1}.");
...
const u8 gText_LanettesPC[] = _("Kevin's PC");
...
const u8 gText_PokenavMatchCall_Strategy[] = _("Strats");
...
const u8 gText_Questionnaire[] = _("QUuestionnaire");
...
const u8 gText_MayBrendanMatchCallDesc[] = _("Gigachad");
const u8 gText_NormanMatchCallDesc[] = _("Sealed-Only");
const u8 gText_MomMatchCallDesc[] = _("Calm & Kind");
const u8 gText_WallyMatchCallDesc[] = _("Dragon Enjoyer");
const u8 gText_NormanMatchCallName[] = _("Nyhmnim");
const u8 gText_MomMatchCallName[] = _("Mom");
const u8 gText_ScottMatchCallDesc[] = _("PEND GOD");
const u8 gText_ScottMatchCallName[] = _("TRIF");
const u8 gText_RoxanneMatchCallDesc[] = _("EP Scarm");
const u8 gText_BrawlyMatchCallDesc[] = _("1000 Atk");
const u8 gText_WattsonMatchCallDesc[] = _("Sissy Hypnos");
const u8 gText_FlanneryMatchCallDesc[] = _("Branded in WHITE");
const u8 gText_WinonaMatchCallDesc[] = _("Toxic e-Girl");
const u8 gText_TateLizaMatchCallDesc[] = _("Meme Review");
const u8 gText_JuanMatchCallDesc[] = _("Labrynth Lass");
const u8 gText_EliteFourMatchCallDesc[] = _("Dev Team");
const u8 gText_ChampionMatchCallDesc[] = _("Lead Dev");
...
const u8 gText_MovesMenu[] = _("Change Moves");
