//To accommodate the fact that Ruggles is always the same GFX_ID,
//and always has the same party, rival scripts are modified.
//This includes scripts calling which rival party to use.
//For simplicity's sake, all of Ruggles' teams throughout
//the game will refer to Brendan's party as if the player chose Treecko.
...
const struct Trainer gTrainers[] = {
    ...
    [TRAINER_FELIX] =
    {
        ...
        .doubleBattle = FALSE,
        .aiFlags = AI_FLAG_CHECK_BAD_MOVE | AI_FLAG_TRY_TO_FAINT | AI_FLAG_CHECK_VIABILITY,
        .party = EVERYTHING_CUSTOMIZED(sParty_Souls),
    },
    ...
    [TRAINER_EDGAR] =
    {
        ...
        .encounterMusic_gender = TRAINER_ENCOUNTER_MUSIC_COOL,
        .trainerPic = TRAINER_PIC_BIRD_KEEPER,
        .trainerName = _("TheNMan75"),
        .items = {ITEM_FULL_RESTORE, ITEM_NONE, ITEM_NONE, ITEM_NONE},
        .doubleBattle = FALSE,
        .aiFlags = AI_FLAG_CHECK_BAD_MOVE | AI_FLAG_TRY_TO_FAINT | AI_FLAG_CHECK_VIABILITY,
        .party = EVERYTHING_CUSTOMIZED(sParty_NMan),
    },
    ...
    [TRAINER_ALBERT] =
    {
        ...
        .doubleBattle = FALSE,
        .aiFlags = AI_FLAG_CHECK_BAD_MOVE | AI_FLAG_TRY_TO_FAINT | AI_FLAG_CHECK_VIABILITY,
        .party = EVERYTHING_CUSTOMIZED(sParty_MirorBVR),
    },
    ...
    [TRAINER_SAMUEL] =
    {
        ...
        .trainerName = _("Renvil"),
        .items = {ITEM_FULL_RESTORE, ITEM_NONE, ITEM_NONE, ITEM_NONE},
        .doubleBattle = FALSE,
        .aiFlags = AI_FLAG_CHECK_BAD_MOVE | AI_FLAG_TRY_TO_FAINT | AI_FLAG_CHECK_VIABILITY,
        .party = EVERYTHING_CUSTOMIZED(sParty_Renvil),
    },
    ...
    [TRAINER_VITO] =
    {
        ...
        .encounterMusic_gender = TRAINER_ENCOUNTER_MUSIC_COOL,
        .trainerPic = TRAINER_PIC_COOLTRAINER_M,
        .trainerName = _("Zebatman"),
        .items = {ITEM_FULL_RESTORE, ITEM_NONE, ITEM_NONE, ITEM_NONE},
        .doubleBattle = FALSE,
        .aiFlags = AI_FLAG_CHECK_BAD_MOVE | AI_FLAG_TRY_TO_FAINT | AI_FLAG_CHECK_VIABILITY,
        .party = EVERYTHING_CUSTOMIZED(sParty_Zebatman),
    },
    ...
    [TRAINER_OWEN] =
    {
        ...
        .trainerName = _("Dzeeff"),
        .items = {ITEM_FULL_RESTORE, ITEM_NONE, ITEM_NONE, ITEM_NONE},
        .doubleBattle = FALSE,
        .aiFlags = AI_FLAG_CHECK_BAD_MOVE | AI_FLAG_TRY_TO_FAINT | AI_FLAG_CHECK_VIABILITY,
        .party = EVERYTHING_CUSTOMIZED(sParty_Dzeeff),
    },
    ...
    [TRAINER_HOPE] =
    {
        ...
        .encounterMusic_gender = TRAINER_ENCOUNTER_MUSIC_COOL,
        .trainerPic = TRAINER_PIC_COOLTRAINER_M,
        .trainerName = _("Sasori"),
        .items = {ITEM_FULL_RESTORE, ITEM_NONE, ITEM_NONE, ITEM_NONE},
        .doubleBattle = FALSE,
        .aiFlags = AI_FLAG_CHECK_BAD_MOVE | AI_FLAG_TRY_TO_FAINT | AI_FLAG_CHECK_VIABILITY,
        .party = EVERYTHING_CUSTOMIZED(sParty_Sasori),
    },
    ...
    [TRAINER_SHANNON] =
    {
        ...
        .encounterMusic_gender = TRAINER_ENCOUNTER_MUSIC_COOL,
        .trainerPic = TRAINER_PIC_POKEMON_RANGER_M,
        .trainerName = _("cinimod"),
        .items = {ITEM_FULL_RESTORE, ITEM_NONE, ITEM_NONE, ITEM_NONE},
        .doubleBattle = FALSE,
        .aiFlags = AI_FLAG_CHECK_BAD_MOVE | AI_FLAG_TRY_TO_FAINT | AI_FLAG_CHECK_VIABILITY,
        .party = EVERYTHING_CUSTOMIZED(sParty_Cinimod),
    },
    ...
    [TRAINER_MICHELLE] =
    {
        ...
        .trainerName = _("Uglysailor"),
        .items = {ITEM_FULL_RESTORE, ITEM_NONE, ITEM_NONE, ITEM_NONE},
        .doubleBattle = FALSE,
        .aiFlags = AI_FLAG_CHECK_BAD_MOVE | AI_FLAG_TRY_TO_FAINT | AI_FLAG_CHECK_VIABILITY,
        .party = EVERYTHING_CUSTOMIZED(sParty_Uglysailor),
    },
    ...
    [TRAINER_CAROLINE] =
    {
        ...
        .trainerName = _("Gentleben"),
        .items = {ITEM_FULL_RESTORE, ITEM_NONE, ITEM_NONE, ITEM_NONE},
        .doubleBattle = FALSE,
        .aiFlags = AI_FLAG_CHECK_BAD_MOVE | AI_FLAG_TRY_TO_FAINT | AI_FLAG_CHECK_VIABILITY,
        .party = EVERYTHING_CUSTOMIZED(sParty_Gentleben),
    },
    ...
    [TRAINER_JULIE] =
    {
        ...
        .doubleBattle = FALSE,
        .aiFlags = AI_FLAG_CHECK_BAD_MOVE | AI_FLAG_TRY_TO_FAINT | AI_FLAG_CHECK_VIABILITY,
        .party = EVERYTHING_CUSTOMIZED(sParty_Fyre),
    },
    ...
    [TRAINER_QUINCY] =
    {
        ...
        .encounterMusic_gender = TRAINER_ENCOUNTER_MUSIC_COOL,
        .trainerPic = TRAINER_PIC_PSYCHIC_M,
        .trainerName = _("Strobat"),
        .items = {ITEM_FULL_RESTORE, ITEM_NONE, ITEM_NONE, ITEM_NONE},
        .doubleBattle = FALSE,
        .aiFlags = AI_FLAG_CHECK_BAD_MOVE | AI_FLAG_TRY_TO_FAINT | AI_FLAG_CHECK_VIABILITY,
        .party = EVERYTHING_CUSTOMIZED(sParty_Strobat),
    },
    ...
    [TRAINER_KATELYNN] =
    {
        ...
        .trainerName = _("Kanaryu"),
        .items = {ITEM_FULL_RESTORE, ITEM_NONE, ITEM_NONE, ITEM_NONE},
        .doubleBattle = FALSE,
        .aiFlags = AI_FLAG_CHECK_BAD_MOVE | AI_FLAG_TRY_TO_FAINT | AI_FLAG_CHECK_VIABILITY,
        .party = EVERYTHING_CUSTOMIZED(sParty_Kanaryu),
    },
    ...
    [TRAINER_DIANNE] =
    {
        ...
        .trainerName = _("AntiAnt"),
        .items = {ITEM_FULL_RESTORE, ITEM_NONE, ITEM_NONE, ITEM_NONE},
        .doubleBattle = FALSE,
        .aiFlags = 0,
        .party = EVERYTHING_CUSTOMIZED(sParty_AntiAnt),
    },
    ...
    [TRAINER_BRENDAN_ROUTE_103_TORCHIC] = //first Miror B
    {
        .trainerClass = TRAINER_CLASS_SALON_MAIDEN,
        .encounterMusic_gender = TRAINER_ENCOUNTER_MUSIC_MALE,
        .trainerPic = TRAINER_PIC_SALON_MAIDEN_ANABEL,
        ...
        .doubleBattle = FALSE,
        .aiFlags = AI_FLAG_CHECK_BAD_MOVE | AI_FLAG_TRY_TO_FAINT | AI_FLAG_CHECK_VIABILITY,
        .party = EVERYTHING_CUSTOMIZED(sParty_MirorBRoute119),
    },

    [TRAINER_BRENDAN_ROUTE_110_TORCHIC] = //second Miror B
    {
        .trainerClass = TRAINER_CLASS_RIVAL,
        .encounterMusic_gender = TRAINER_ENCOUNTER_MUSIC_MALE,
        .trainerPic = TRAINER_PIC_BRENDAN,
    ...
    [TRAINER_BRENDAN_ROUTE_119_TORCHIC] = //jumpscare
    {
        ...
        .doubleBattle = FALSE,
        .aiFlags = AI_FLAG_CHECK_BAD_MOVE | AI_FLAG_TRY_TO_FAINT | AI_FLAG_CHECK_VIABILITY,
        .party = EVERYTHING_CUSTOMIZED(sParty_UltimateWoman),
    },
    ...
    [TRAINER_MITCHELL] =
    {
        ...
        .encounterMusic_gender = TRAINER_ENCOUNTER_MUSIC_COOL,
        .trainerPic = TRAINER_PIC_RUIN_MANIAC,
        .trainerName = _("Gredora"),
        .items = {},
        .doubleBattle = FALSE,
        .aiFlags = AI_FLAG_CHECK_BAD_MOVE | AI_FLAG_TRY_TO_FAINT | AI_FLAG_CHECK_VIABILITY,
        .party = EVERYTHING_CUSTOMIZED(sParty_Gredora),
    },
    ...
    [TRAINER_HALLE] =
    {
        ...
        .encounterMusic_gender = TRAINER_ENCOUNTER_MUSIC_COOL,
        .trainerPic = TRAINER_PIC_POKEMANIAC,
        .trainerName = _("Maxwmaier"),
        .items = {ITEM_FULL_RESTORE, ITEM_NONE, ITEM_NONE, ITEM_NONE},
        .doubleBattle = FALSE,
        .aiFlags = AI_FLAG_CHECK_BAD_MOVE | AI_FLAG_TRY_TO_FAINT | AI_FLAG_CHECK_VIABILITY,
        .party = EVERYTHING_CUSTOMIZED(sParty_Maxwmaier),
    },
