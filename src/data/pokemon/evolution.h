const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_PSYDUCK]               = {{EVO_LEVEL, 31, SPECIES_GOLDUCK}},
    ...
    [SPECIES_GRAVELER]              = {{EVO_LEVEL, 33, SPECIES_GOLEM}},
    [SPECIES_PONYTA]                = {{EVO_LEVEL, 28, SPECIES_RAPIDASH}},
    [SPECIES_SLOWPOKE]              = {{EVO_LEVEL, 29, SPECIES_SLOWBRO},
    ...
    [SPECIES_SEADRA]                = {{EVO_TRADE_ITEM, ITEM_DRAGON_SCALE, SPECIES_KINGDRA},
                                       {EVO_ITEM, ITEM_LINKING_CORD, SPECIES_KINGDRA}},
...
#if P_GEN_4_POKEMON == TRUE
    [SPECIES_GLIGAR]                = {{EVO_TRADE_ITEM, ITEM_RAZOR_FANG, SPECIES_GLISCOR},
                                       {EVO_ITEM, ITEM_RAZOR_FANG, SPECIES_GLISCOR}},
#endif
    [SPECIES_SNUBBULL]              = {{EVO_LEVEL, 23, SPECIES_GRANBULL}},
#if P_GEN_4_POKEMON == TRUE
    [SPECIES_SNEASEL]               = {{EVO_TRADE_ITEM, ITEM_RAZOR_CLAW, SPECIES_WEAVILE},
    ...
    [SPECIES_SPHEAL]                = {{EVO_LEVEL, 31, SPECIES_SEALEO}},
    ...
    [SPECIES_BUNEARY]               = {{EVO_ITEM, ITEM_SUN_STONE, SPECIES_LOPUNNY}},
    [SPECIES_GLAMEOW]               = {{EVO_LEVEL, 29, SPECIES_PURUGLY}},
    ...
    [SPECIES_MUNCHLAX]              = {{EVO_ITEM, ITEM_MOON_STONE, SPECIES_SNORLAX}},
    ...
    [SPECIES_SNOVER]                = {{EVO_ITEM, ITEM_ICE_STONE, SPECIES_ABOMASNOW}},
#endif
