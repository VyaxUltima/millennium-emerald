const u8 gTrainerClassNames[][13] = {
    ...
    [TRAINER_CLASS_COOLTRAINER_2] = _("Ace Trainer"), //if needed, replace - only one trainer uses this
    [TRAINER_CLASS_MAGMA_ADMIN] = _("Magma Admin"),
    [TRAINER_CLASS_RIVAL] = _("{PKMN} Trainer"), //edit this for Ruggles
    ...
    [TRAINER_CLASS_SALON_MAIDEN] = _("Salon Maiden"), //edit this for Miror B
    [TRAINER_CLASS_DOME_ACE] = _("Dome Ace"), //edit this for Duckie
    [TRAINER_CLASS_PALACE_MAVEN] = _("Palace Maven"), //edit this for Bakura
    [TRAINER_CLASS_ARENA_TYCOON] = _("Arena Tycoon"), //edit this for Mutt
    [TRAINER_CLASS_FACTORY_HEAD] = _("Factory Head"), //edit this for Vyax
