...
static const u8 sStenchDescription[] = _("This Pokémon's attacks have\na 10% flinch chance.");
static const u8 sDrizzleDescription[] = _("Summons rain when\nswitched in.");
static const u8 sSpeedBoostDescription[] = _("Boosts the Pokémon's Speed\nat the end of each turn.");
static const u8 sBattleArmorDescription[] = _("This Pokémon is immune\nto critical hits.");
static const u8 sSturdyDescription[] = _("This Pokémon cannot be KO'd\nin a single hit.");
static const u8 sDampDescription[] = _("Explosion and Selfdestruct\nwill fail if used.");
static const u8 sLimberDescription[] = _("This Pokémon is immune\nto paralysis.");
static const u8 sSandVeilDescription[] = _("While in sand, evasion\nincreases by 20%.");
static const u8 sStaticDescription[] = _("Paralyzes on contact\n30% of the time.");
static const u8 sVoltAbsorbDescription[] = _("Electric moves restore 25%\nof this Pokémon's HP.");
static const u8 sWaterAbsorbDescription[] = _("Water moves restore 25%\nof this Pokémon's HP.");
static const u8 sObliviousDescription[] = _("Immune to Attract, Taunt,\n and Intimidate.");
static const u8 sCloudNineDescription[] = _("While on the field,\nweather effects are nulled.");
static const u8 sCompoundEyesDescription[] = _("The Pokémon's accuracy\nis increased by 30%.");
static const u8 sInsomniaDescription[] = _("This Pokémon cannot be\nput to sleep.");
static const u8 sColorChangeDescription[] = _("Foe's attack type is\ncopied by Kecleon.");
static const u8 sImmunityDescription[] = _("This Pokémon is immune\nto poisoning.");
static const u8 sFlashFireDescription[] = _("50% boost to Fire moves\nif hit by a Fire move.");
static const u8 sShieldDustDescription[] = _("Move's additional effects\nare nullified.");
static const u8 sOwnTempoDescription[] = _("This Pokémon cannot be\nconfused or intimidated.");
static const u8 sSuctionCupsDescription[] = _("This Pokémon cannot be\nforcibly switched out.");
static const u8 sIntimidateDescription[] = _("On entry, lowers the\nopponent's Attack.");
static const u8 sShadowTagDescription[] = _("Opposing Pokémon can't be\nmanually switched out.");
static const u8 sRoughSkinDescription[] = _("Attackers making contact\nlose 1/8 of their HP.");
static const u8 sWonderGuardDescription[] = _("Immune to attacks, unless\nthey are super-effective.");
static const u8 sLevitateDescription[] = _("This Pokémon is immune\nto Ground moves.");
static const u8 sEffectSporeDescription[] = _("When hit by contact, 30%\nchance to PSN, PAR or SLP.");
static const u8 sSynchronizeDescription[] = _("Non-sleep status is\nmirrored onto opponent.");
static const u8 sClearBodyDescription[] = _("Opposing Pokémon can't\ndrop this Pokémon's stats.");
static const u8 sNaturalCureDescription[] = _("Switching out will cure\nstatus conditions.");
static const u8 sLightningRodDescription[] = _("Draws electrical moves,\nand gains Sp. Atk.");
static const u8 sSereneGraceDescription[] = _("The Pokémon's move effects\noccur twice as often.");
static const u8 sSwiftSwimDescription[] = _("While in rain, the Pokémon's\nSpeed is doubled.");
static const u8 sChlorophyllDescription[] = _("While in sun, the Pokémon's\nSpeed is doubled.");
static const u8 sIlluminateDescription[] = _("This Pokémon's accuracy\nis increased by 30%.");
static const u8 sTraceDescription[] = _("Copies an opponent's\nability on switch-in.");
static const u8 sHugePowerDescription[] = _("The Attack stat of the\nPokémon is doubled.");
static const u8 sPoisonPointDescription[] = _("Poisons on contact\n30% of the time.");
static const u8 sInnerFocusDescription[] = _("This Pokémon cannot flinch\nor be intimidated.");
static const u8 sMagmaArmorDescription[] = _("This Pokémon cannot be\nfrozen.");
static const u8 sWaterVeilDescription[] = _("This Pokémon cannot be\nburned.");
static const u8 sMagnetPullDescription[] = _("Opposing Steels cannot be\nmanually switched out.");
static const u8 sSoundproofDescription[] = _("Sound-based moves will\nhave no effect.");
static const u8 sRainDishDescription[] = _("Recovers 1/16 HP in rain\nat the end of each turn.");
static const u8 sSandStreamDescription[] = _("Summons a sandstorm\nwhen switched in.");
static const u8 sPressureDescription[] = _("Opponent's moves will\nconsume another PP.");
static const u8 sThickFatDescription[] = _("Halves damage from\nIce and Fire moves.");
static const u8 sEarlyBirdDescription[] = _("Awakens twice as\nquickly from sleep.");
static const u8 sFlameBodyDescription[] = _("Burns on contact\n30% of the time.");
static const u8 sRunAwayDescription[] = _("Fleeing will always\nbe successful.");
static const u8 sKeenEyeDescription[] = _("This Pokémon cannot have\nits accuracy reduced.");
static const u8 sHyperCutterDescription[] = _("Opposing Pokémon can't\ndrop this Pokémon's Attack.");
static const u8 sPickupDescription[] = _("May pick up items\nwhen a battle ends.");
static const u8 sTruantDescription[] = _("The Pokémon is lazy and\nmoves half as often.");
static const u8 sHustleDescription[] = _("20% boost to Attack,\nbut 10% accuracy loss.");
static const u8 sCuteCharmDescription[] = _("Infatuates on contact\n30% of the time.");
static const u8 sPlusDescription[] = _("50% Sp. Atk boost if\npaired with Plus/Minus.");
static const u8 sMinusDescription[] = _("50% Sp. Atk boost if\npaired with Plus/Minus.");
static const u8 sForecastDescription[] = _("Castform will change\nbased on the weather.");
static const u8 sStickyHoldDescription[] = _("This Pokémon's items can't\nbe removed by opponents.");
static const u8 sShedSkinDescription[] = _("At the end of each turn,\n33% chance to heal status.");
static const u8 sGutsDescription[] = _("Ups Attack 50% if statused.\nIgnores burn Attack drop.");
static const u8 sMarvelScaleDescription[] = _("50% Defense boost\nif statused.");
static const u8 sLiquidOozeDescription[] = _("Draining moves damage the\nuser instead of healing.");
...
static const u8 sRockHeadDescription[] = _("This Pokémon doesn't take\ndamage from recoil.");
static const u8 sDroughtDescription[] = _("Summons sunlight when\nswitched in.");
static const u8 sArenaTrapDescription[] = _("Opponents cannot switch\nmanually or flee.");
static const u8 sVitalSpiritDescription[] = _("This Pokémon cannot be\nput to sleep.");
static const u8 sWhiteSmokeDescription[] = _("Opposing Pokémon can't\ndrop this Pokémon's stats.");
static const u8 sPurePowerDescription[] = _("The Attack stat of the\nPokémon is doubled.");
static const u8 sShellArmorDescription[] = _("This Pokémon is immune\nto critical hits.");
static const u8 sAirLockDescription[] = _("Weather effects are nulled.");
static const u8 sTangledFeetDescription[] = _("Ups evasion if confused.");
static const u8 sMotorDriveDescription[] = _("Raises Speed when hit\nby Electric moves.");
static const u8 sRivalryDescription[] = _("10% damage boost against\nthe same gender.");
static const u8 sSteadfastDescription[] = _("Raises Speed if the\nPokémon flinches.");
static const u8 sSnowCloakDescription[] = _("While in hail, evasion\nincreases by 20%.");
static const u8 sGluttonyDescription[] = _("Certain berries are eaten\nat 50% HP instead of 25%.");
static const u8 sAngerPointDescription[] = _("Being struck by a critical\nhit maximizes Attack.");
static const u8 sUnburdenDescription[] = _("Speed is doubled if a\nheld item is used up.");
static const u8 sHeatproofDescription[] = _("Burns and Fire moves\ndeal half damage.");
static const u8 sSimpleDescription[] = _("This Pokémon's stat\nchanges are doubled.");
static const u8 sDrySkinDescription[] = _("Water restores HP.\nFire deals more damage.");
static const u8 sDownloadDescription[] = _("Raises Atk or Sp. Atk\nbased on foe's defenses.");
static const u8 sIronFistDescription[] = _("Punching moves receive a\n20% damage boost.");
static const u8 sPoisonHealDescription[] = _("While poisoned, heals 1/8 HP\nat the end of each turn.");
static const u8 sAdaptabilityDescription[] = _("STAB moves receive a\n2x multiplier, over 1.5x.");
static const u8 sSkillLinkDescription[] = _("This Pokémon's multi-hit\nmoves always hit 5 times.");
static const u8 sHydrationDescription[] = _("While in rain, status\nconditions are cured.");
static const u8 sSolarPowerDescription[] = _("In sun, ups Sp. Atk 50%\nbut loses 1/8 HP each turn.");
static const u8 sQuickFeetDescription[] = _("Ups Speed 50% if statused.\nNo paralysis Speed drop.");
static const u8 sNormalizeDescription[] = _("Attacks are Normal type\nand receive 20% boost.");
static const u8 sSniperDescription[] = _("Critical hits will deal\n50% more damage.");
static const u8 sMagicGuardDescription[] = _("This Pokémon is only\ndamaged by attacks.");
static const u8 sNoGuardDescription[] = _("While on the field,\nall attacks will land.");
static const u8 sStallDescription[] = _("get fucked");
static const u8 sTechnicianDescription[] = _("Moves at or below 60 Power\nget 50% more power.");
static const u8 sLeafGuardDescription[] = _("While in sun, status\ncannot be inflicted.");
static const u8 sKlutzDescription[] = _("This Pokémon's hold items\nwill have no effect.");
static const u8 sMoldBreakerDescription[] = _("Ignores abilities of\nfoes when attacking.");
static const u8 sSuperLuckDescription[] = _("This Pokémon's attacks\nland critical hits more.");
static const u8 sAftermathDescription[] = _("Fainting to contact\ndamages the attacker.");
static const u8 sAnticipationDescription[] = _("Warns about the presence\nof super-effective moves.");
static const u8 sForewarnDescription[] = _("Foe's highest power move\nis revealed.");
static const u8 sUnawareDescription[] = _("Opponent's stat changes\nare ignored.");
static const u8 sTintedLensDescription[] = _("Doubles damage of user's\nnot very effective moves.");
static const u8 sFilterDescription[] = _("Takes 75% damage from\nsuper-effective moves.");
static const u8 sSlowStartDescription[] = _("eat shit");
static const u8 sScrappyDescription[] = _("Normal/Fighting moves hit\nGhosts. Blocks Intimidate.");
static const u8 sStormDrainDescription[] = _("Draws water moves,\nand gains Sp. Atk.");
static const u8 sIceBodyDescription[] = _("Recovers 1/16 HP in hail\nat the end of each turn.");
#if B_SNOW_WARNING < GEN_9
static const u8 sSnowWarningDescription[] = _("Summons hail when\nswitched in.");
#elif B_SNOW_WARNING >= GEN_9
static const u8 sSnowWarningDescription[] = _("Summons snow when\nswitched in.");
#endif
static const u8 sHoneyGatherDescription[] = _("May gather Honey.");
static const u8 sFriskDescription[] = _("When switched in,\nchecks a foe's item.");
static const u8 sRecklessDescription[] = _("Recoil moves receive a\n20% damage boost.");
static const u8 sMultitypeDescription[] = _("Changes type to its Plate.");
static const u8 sFlowerGiftDescription[] = _("Cherrim ups Atk and Sp. Def\nof itself and allies.");
static const u8 sBadDreamsDescription[] = _("Damages sleeping Pokémon.");

//Gen 5+ abilities start here
...
static const u8 sCreatorsWardDescription[] = _("This Pokémon takes 20%\nless damage from attacks.");
...
const u8 gAbilityNames[ABILITIES_COUNT][ABILITY_NAME_LENGTH + 1] =
{
    ...
    [ABILITY_CREATORS_WARD] = _("Creator's Ward"),
};
#else   // 12 characters
const u8 gAbilityNames[ABILITIES_COUNT][ABILITY_NAME_LENGTH + 1] =
{
    ...
    [ABILITY_CREATORS_WARD] = _("Creator Ward"),
};
#endif
...
const u8 *const gAbilityDescriptionPointers[ABILITIES_COUNT] =
{
    ...
    [ABILITY_CREATORS_WARD] = sCreatorsWardDescription,
};
