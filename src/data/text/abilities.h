...
static const u8 sStenchDescription[] = _("Attacks made by the user\nhave a 10% flinch chance.");
static const u8 sDrizzleDescription[] = _("Summons rain when\nswitched in.");
static const u8 sSpeedBoostDescription[] = _("Boosts the user's Speed\nat the end of each turn.");
static const u8 sBattleArmorDescription[] = _("This Pokémon is immune\nto critical hits.");
static const u8 sSturdyDescription[] = _("User cannot be KO'd\nin a single hit.");
...
static const u8 sVoltAbsorbDescription[] = _("Electric moves restore\n25% of the user's HP.");
static const u8 sWaterAbsorbDescription[] = _("Water moves restore\n25% of the user's HP.");
static const u8 sObliviousDescription[] = _("Immune to effects of\nAttract or Taunt.");
static const u8 sCloudNineDescription[] = _("Weather effects are nulled.");
static const u8 sCompoundEyesDescription[] = _("The user's accuracy is\nincreased by 30%.");
...
static const u8 sShadowTagDescription[] = _("Opposing Pokémon cannot be\nmanually switched out.");
...
static const u8 sSereneGraceDescription[] = _("Effect chances of user's\nmoves are doubled.");
static const u8 sSwiftSwimDescription[] = _("While in rain, user's\nSpeed is doubled.");
static const u8 sChlorophyllDescription[] = _("While in sun, user's\nSpeed is doubled.");
static const u8 sIlluminateDescription[] = _("The user's accuracy is\nincreased by 30%.");
...
static const u8 sInnerFocusDescription[] = _("This Pokémon cannot be\nmade to flinch.");
...
static const u8 sStickyHoldDescription[] = _("User's items cannot be\nremoved by opponents.");
...
static const u8 sRockHeadDescription[] = _("Recoil damage is not\ndealt to the user.");
...
static const u8 sSkillLinkDescription[] = _("User's multi-hit moves\nalways hit 5 times.");
...
static const u8 sNormalizeDescription[] = _("User's attacks are Normal,\nand receive 20% boost.");
...
static const u8 sNoGuardDescription[] = _("User's and foe's attacks\nwill always land.");
...
static const u8 sKlutzDescription[] = _("Hold items will have\nno effect.");
...
static const u8 sFilterDescription[] = _("User takes 75% damage from\nsuper-effective moves.");
static const u8 sSlowStartDescription[] = _("eat shit");
static const u8 sScrappyDescription[] = _("Can hit Ghosts with\nNormal and Fighting.");
