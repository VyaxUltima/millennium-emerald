...
static const u8 sDoorAnimTiles_SootopolisGym[] = INCBIN_U8("graphics/door_anims/sootopolis_gym_interior.4bpp");
...
static const u8 sDoorAnimPalettes_SootopolisGym[] = {8, 8, 8, 8, 8, 8, 8, 8};
...
static const struct DoorGraphics sDoorAnimGraphicsTable[] =
{
    ...
    {METATILE_Sootopolis_Gym_Door_Interior,                 DOOR_SOUND_NORMAL,  1, sDoorAnimTiles_SootopolisGym, sDoorAnimPalettes_SootopolisGym},
    {},
};
