...
#define BAG_ITEMS_COUNT 60 //if you run out of bag space, L
#define BAG_KEYITEMS_COUNT 30
#define BAG_POKEBALLS_COUNT 27 //I ball like a Laker
#define BAG_TMHM_COUNT 100
#define BAG_BERRIES_COUNT 68 //not using all 68 but who gives a fucking shit
